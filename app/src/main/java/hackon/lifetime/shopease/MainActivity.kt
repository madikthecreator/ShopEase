...
val products = mutableListOf(
    ...
    Product(
        2, "Canteen Table", "10,500", R.drawable.table,
        "FREE delivery by Thu, 18 Feb",
    ...
    Product(
        3, "Pedestal Fan", "12,200", R.drawable.pedestal_fan,
        "FREE delivery by Mon, 22 Feb",
    ...
    Product(
        4, "Mobile Tripod", "3500", R.drawable.tripod_image,
        "FREE delivery by Wed, 24 Feb",
    ...
    Product(
        5, "Office Chair", "22,880", R.drawable.office_chair,
        "FREE delivery by Tue, 20 Feb",
    ...
    Product(
        7, "Park Bench", "17,500", R.drawable.park_bench_photo,
        "FREE delivery by Fri, 12 Feb",
    ...
    Product(
        8, "Microwave Oven", "32,999", R.drawable.oven_photo,
        "FREE delivery by Thu, 17 Feb",
